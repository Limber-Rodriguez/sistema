                            ...
                            <form name="formulario" id="formulario" method="POST">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="number" class="form-control" name="telefono" id="telefono" placeholder="Telefono" maxlength="20" required>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>Email(*)</label>
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>Cargo(*)</label>
                                        <input type="text" class="form-control" name="cargo" id="cargo" placeholder="Cargo" maxlength="20" required>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>Login(*)</label>
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>Clave(*)</label>
                                        <input type="text" class="form-control" name="clave" id="clave" placeholder="Clave" maxlength="64" required>
                                    </div>
